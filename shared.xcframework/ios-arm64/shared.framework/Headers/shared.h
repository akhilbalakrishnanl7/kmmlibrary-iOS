...
- (SharedRuntimeQuery<id> *)selectAllLaunchesInfoMapper:(id (^)(SharedLong *, NSString *, NSString * _Nullable, SharedBoolean * _Nullable, NSString *, NSString * _Nullable, NSString * _Nullable, NSString * _Nullable))mapper __attribute__((swift_name("selectAllLaunchesInfo(mapper:)")));
@end
